...
public class vendorStatus extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new ArrayAdapter(vendorStatus.this,android.R.layout.simple_list_item_1,fvArrayList);
            ...
            public void handleMessage(android.os.Message msg) {
                try {
                    if (msg.what == handlerState) {                                     //if message is what we want
                        ...
                        Toast.makeText(vendorStatus.this, "Entered Handler " + endOfLineIndex + readMessage, Toast.LENGTH_SHORT).show();
                        if (endOfLineIndex > 0) {                                           // make sure there data before ~
                            String dataInPrint = recDataString.substring(0, endOfLineIndex);    // extract string
                            txtString.setText("Data Received = " + dataInPrint);
                            int dataLength = dataInPrint.length();                          //get length of data received
                            txtStringLength.setText("String Length = " + String.valueOf(dataLength));
                            Toast.makeText(vendorStatus.this, "Entered Handler innner  " + recDataString.charAt(0), Toast.LENGTH_SHORT).show();
                            if (recDataString.charAt(0) == '#')                             //if it starts with # we know it is what we are looking for
                            {
                                ...
                                try {
                                    ...
                                    Toast.makeText(vendorStatus.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
